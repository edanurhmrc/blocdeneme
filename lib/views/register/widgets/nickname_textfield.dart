...
class nickname_textfield extends StatelessWidget {
  const nickname_textfield({Key? key}) : super(key: key);
    ...
    return BlocBuilder<RegisterBloc, RegisterState>(
      builder: (context,state) {
        return TextFormField(
          ...
          onChanged: (value) =>
              context.read<RegisterBloc>().add(RegisterNicknameChanged(nickname: value)),
          validator: (value) =>
          state.isValidNickname ? null : "Lütfen nickname giriniz",
        );
      }
    );
  }
